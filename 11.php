...
for($i = 0;$i <= 16; $i++){
    for($j = 0;$j <= 16; $j++){
        $result[] = $data[$i][$j] * $data[$i][$j + 1] * $data[$i][$j + 2] * $data[$i][$j + 3];
        $result[] = $data[$i][$j] * $data[$i + 1][$j] * $data[$i + 2][$j] * $data[$i + 3][$j];
        $result[] = $data[$i][$j] * $data[$i + 1][$j + 1] * $data[$i + 2][$j + 2] * $data[$i + 3][$j + 3];
        $result[] = $data[$i + 3][$j] * $data[$i + 2][$j + 1] * $data[$i + 1][$j + 2] * $data[$i][$j + 3];

        //此处在以下测试时已修改正确，但是以上真正用于比较的却忘记修改，导致浪费了半小时都排查不到原因
        //$result[] = $data[$i + 3][$j] * $data[$i + 2][$j + 3] * $data[$i + 3][$j + 2] * $data[$i][$j + 3];

        //$result[$i . '_' . $j][$data[$i][$j] . '_' . $data[$i][$j + 1] . '_' . $data[$i][$j + 2] . '_' . $data[$i][$j + 3]] = $data[$i][$j] * $data[$i][$j + 1] * $data[$i][$j + 2] * $data[$i][$j + 3];
        ...
        if($i == 16){
            ...
            //$result2[$data[$i + 1][$j] . '_' . $data[$i + 1][$j + 1] . '_' . $data[$i + 1][$j + 2] . '_' . $data[$i + 1][$j + 3]] = $data[$i + 1][$j] * $data[$i + 1][$j + 1] * $data[$i + 1][$j + 2] * $data[$i + 1][$j + 3];
        ...
        if($j == 16){
            ...
            //$result3[$data[$i][$j + 1] . '_' . $data[$i + 1][$j + 1] . '_' . $data[$i + 2][$j + 1] . '_' . $data[$i + 3][$j + 1]] = $data[$i][$j + 1] * $data[$i + 1][$j + 1] * $data[$i + 2][$j + 1] * $data[$i + 3][$j + 1];
            //$result3[$data[$i][$j + 2] . '_' . $data[$i + 1][$j + 2] . '_' . $data[$i + 2][$j + 2] . '_' . $data[$i + 3][$j + 2]] = $data[$i][$j + 2] * $data[$i + 1][$j + 2] * $data[$i + 2][$j + 2] * $data[$i + 3][$j + 2];
            //$result3[$data[$i][$j + 3] . '_' . $data[$i + 1][$j + 3] . '_' . $data[$i + 2][$j + 3] . '_' . $data[$i + 3][$j + 3]] = $data[$i][$j + 3] * $data[$i + 1][$j + 3] * $data[$i + 2][$j + 3] * $data[$i + 3][$j + 3];
